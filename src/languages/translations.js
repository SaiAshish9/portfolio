export const translations = [
  ...
  {
    text: "introDesc3",
    en: "Final year computer science student (21 yrs)",
    pt: "Estudante de ciência da computação do último ano (21 anos)",
    hi: "अंतिम वर्ष का कंप्यूटर विज्ञान का छात्र (21 वर्ष)",
    te: "చివరి సంవత్సరం కంప్యూటర్ సైన్స్ విద్యార్థి (21 సంవత్సరాలు)",
    de: "Informatikstudent im Abschlussjahr (21 Jahre)",
    zh: "最後一年計算機科學專業的學生（21 歲）",
    fr: "Étudiant en dernière année d'informatique (21 ans)",
    ru: "Студент последнего курса информатики (21 лет)",
  },
  {
    text: "location",
    en: "New Delhi, India",
