export const translations = [
  ...
  },
  {
    ...
    pt: "Aguardando a ligação da equipe de talentos de:",
    hi: "की प्रतिभा टीम से कॉल की प्रतीक्षा कर रहा है:",
    te: "టాలెంట్ టీమ్ నుండి కాల్ కోసం వేచి ఉంది:",
    de: "Warten auf den Anruf vom Talentteam von:",
    zh: "等待人才團隊的召喚：",
  ...
  {
    text: "dsaTarget",
    en: "1008 Leetcode Questions + Notes + Interview Questions + Audio Clips + Animated Graphical Representation",
    pt: "1008 Perguntas Leetcode + Notas + Perguntas de Entrevista + Clipes de Áudio + Representação Gráfica Animada",
    hi: "1008 लेटकोड प्रश्न + नोट्स + साक्षात्कार प्रश्न + ऑडियो क्लिप्स + एनिमेटेड ग्राफिकल प्रतिनिधित्व",
    te: "1008 లీట్‌కోడ్ ప్రశ్నలు + గమనికలు + ఇంటర్వ్యూ ప్రశ్నలు + ఆడియో క్లిప్‌లు + యానిమేటెడ్ గ్రాఫికల్ రిప్రజెంటేషన్",
    de: "1008 Leetcode-Fragen + Notizen + Interviewfragen + Audioclips + Animierte grafische Darstellung",
