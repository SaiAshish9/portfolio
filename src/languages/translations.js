export const translations = [
  ...
  {
    text: "teamsDevC",
    en: "Msft Teams Dev Challenge",
    pt: "Desafio de desenvolvimento do Msft Teams",
    hi: "एमएसएफटी टीम देव चैलेंज",
    te: "Msft టీమ్స్ దేవ్ ఛాలెంజ్",
    de: "Msft Teams Dev Challenge",
    zh: "Msft 團隊開發挑戰",
    fr: "Défi de développement des équipes Msft",
    ru: "Соревнование разработчиков Msft Teams",
  },
];
