export const translations = [
  ...
  {
    text: "invite",
    en: "No longer waiting for the call from talent team of:",
    pt: "Não espere mais a ligação da equipe de talentos de:",
    hi: "अब टैलेंट टीम के कॉल का इंतजार नहीं:",
    te: "టాలెంట్ టీమ్ నుండి కాల్ కోసం ఇక వేచి ఉండదు:",
    de: "Warten Sie nicht länger auf den Anruf des Talentteams von:",
    zh: "不再等待人才團隊的召喚：",
    fr: "N'attendez plus l'appel de l'équipe talent de :",
    ru: "Больше не нужно ждать звонка от команды талантов:",
  },
  {
    text: "class12",
    en: "Class 12th",
